...
public class AdminOrderController {
    ...
    public ResponseEntity<?> markOrderAsReady(@PathVariable Long orderId) {
        ...
        String body = "Dear " + order.getCustomerName() + ",\n\n"
                ...
                + "Please visit us to collect your order. Thank you for choosing Taqueria Mexicano Grill & Bar!\n\n"
                + "Best Regards,\nTaqueria Mexicano Grill & Bar Team";
    ...
    public ResponseEntity<?> markOrderAsCompleted(@PathVariable Long orderId) {
        ...
        String body = "Dear " + order.getCustomerName() + ",\n\n"
                ...
                + "Please come again, thank you for choosing Taqueria Mexicano Grill & Bar!\n\n"
                + "Best Regards,\nTaqueria Mexicano Grill & Bar Team";
