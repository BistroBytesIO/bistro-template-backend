...
public class PaymentService {
    ...
    public void sendConfirmationEmails(String transactionId, Long orderId) throws MessagingException {
        ...
        String customerSubject = "Order Confirmation: Your Rita's Mexican Restaurant Order #" + order.getId();
        ...
        String customerHtmlBody = "<!DOCTYPE html>\n" +
                ...
                "                <p style='font-size: 16px;'>Thank you for ordering from Rita's Mexican Restaurant! Your order has been received and will be ready for pickup soon.</p>\n" +
                "                \n" +
        ...
        customerHtmlBody += "                </table>\n" +
                ...
                "                <p style='font-size: 16px;'>If you have any questions, please contact us at <a href='tel:2812329961' style='color: #c6632c; text-decoration: none;'>(281) 232-9961</a>.</p>\n" +
                "                <p style='font-size: 16px;'>Thank you for choosing Rita's Mexican Restaurant!</p>\n" +
                "            </td>\n" +
                "        </tr>\n" +
                "        <!-- FOOTER -->\n" +
                "        <tr>\n" +
                "            <td style='padding: 20px; background-color: #f5f5f5; text-align: center; font-size: 14px; color: #666666;'>\n" +
                "                <p style='margin: 0 0 10px 0;'><strong>Rita's Mexican Restaurant</strong><br>4615 Avenue H, Rosenberg, TX 77471</p>\n" +
                "                <p style='margin: 0; font-size: 12px;'>© 2025 Rita's Mexican Restaurant. All rights reserved.</p>\n" +
                "            </td>\n" +
                "        </tr>\n" +
                "    </table>\n" +
                "</body>\n" +
